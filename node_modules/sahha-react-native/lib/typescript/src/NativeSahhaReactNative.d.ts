...
export declare enum SahhaEnvironment {
    development = "development",
    sandbox = "sandbox",
    production = "production"
}
export declare enum SahhaSensor {
    gender = "gender",
...
export declare enum SahhaSensorStatus {
...
export declare enum SahhaScoreType {
    wellbeing = "wellbeing",
    activity = "activity",
    sleep = "sleep",
    readiness = "readiness",
...
export declare enum SahhaBiomarkerCategory {
    activity = "activity",
    body = "body",
...
export declare enum SahhaBiomarkerType {
    steps = "steps",
    floors_climbed = "floors_climbed",
...
export interface Spec extends TurboModule {
    ...
    getScores(types: Array<SahhaScoreType>, startDateTime: number, endDateTime: number, callback: (error: string, value: string) => void): void;
    getBiomarkers(categories: Array<SahhaBiomarkerCategory>, types: Array<SahhaBiomarkerType>, startDateTime: number, endDateTime: number, callback: (error: string, value: string) => void): void;
    getStats(sensor: SahhaSensor, startDateTime: number, endDateTime: number, callback: (error: string, value: string) => void): void;
    getSamples(sensor: SahhaSensor, startDateTime: number, endDateTime: number, callback: (error: string, value: string) => void): void;
...
//# sourceMappingURL=NativeSahhaReactNative.d.ts.map